...
import backgroundImage1 from '../../images/employee4.jpg';
...
class Login extends Component {
    ...
    render() {
        ...
        return (
            <div>
                <Header />
            <div style={{backgroundImage: `url(${backgroundImage1})`, backgroundSize: '100% 100%', height: '700px'}}>
                ...
                {/* <div className="row mt-5"> */}
                    <div className="col-md-4 mx-auto mt-5 shadow-lg" style={{backgroundImage: `url(${backgroundImage2})`, padding: '40px 80px 60px 80px', borderRadius: '30px'}}>
                        {/* <div className="card-body p-1"> */}
                            <h2 className="text-center mt-3" style={{color: '#7badb3'}}><b>Please enter Admin login credentials</b></h2>
                            <br/>
