                ...
                <div className="col-sm-3 p-sm-2">
                  <div className="card bg-primary text-white shadow-lg">
                    <div className="card-body">
                      ...
                      <Link to="/admins" className="btn btn-light">
                        <FontAwesomeIcon
                ...
                <div className="col-sm-3 p-sm-2">
                  <div className="card bg-primary text-white shadow-lg">
                    <div className="card-body">
                      ...
                      <Link to="/reservations" className="btn btn-light">
                        <FontAwesomeIcon
                          className="text-primary"
                          icon={faUserAlt}
                        />{" "}
                ...
                <div className="col-sm-3 p-sm-2">
                  <div className="card bg-primary text-white shadow-lg">
                    <div className="card-body">
                      ...
                      <p className="card-text">
                        <div style={{ color: "white" }}>View the Feedback</div>
                      </p>
                      <Link to="/feedback" className="btn btn-light">
                        <FontAwesomeIcon
                          className="text-primary"
                          icon={faUserAlt}
                        />{" "}
                ...
                <div className="col-sm-3 p-sm-2">
                  <div className="card bg-primary text-white shadow-lg">
                    <div className="card-body">
                      ...
                      <p className="card-text">
                        <div style={{ color: "white" }}>View the Payment</div>
                      </p>
                      <Link
