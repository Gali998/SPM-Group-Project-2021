...
import { updateUser } from "../../actions/customerActions";
...
class CustomerUpdateModal extends React.Component {
...
export default connect(
    mapStateToProps,
    { updateUser }
)(withRouter(CustomerUpdateModal));
