          ...
          newCustomer
            ...
            .then((user) => {
              return res
                .status(200)
                .json({
                  message: "Customer added successfully. Refreshing data...",
                });
            })
  ...
  Customer.deleteOne({ _id: req.body._id }).then((user) => {
    if (user) {
      return res
        .status(200)
        .json({
          message: "Customer deleted successfully. Refreshing data...",
          success: true,
        });
    }
  });
        ...
        function (err, result) {
          if (err) {
            ...
            return res
              .status(200)
              .json({
                message: "Customer updated successfully. Refreshing data...",
                success: true,
              });
          }
        }
